...
import { getValidationSchema } from '../../../../utils/validationSchema'; // ✅ import validation
  ...
  return (
    <AuthWrapper>
      ...
      <Formik
        ...
        validationSchema={getValidationSchema('addDriver')} // 🔥 you can define schema type in utils
        onSubmit={values => {
          console.log('Form Submitted ✅', { ...values, vehicle, photo });
          navigation.navigate('Driver Added');
        }}
      >
        {({
          handleChange,
