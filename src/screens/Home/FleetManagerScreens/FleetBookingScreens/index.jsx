...
import { fleetbooking } from '../../../../utils/staticData';
...
const FleetBooking = () => {
    ...
    return (
      <View style={styles.card}>
        ...
        <View style={styles.row1}>
          ...
          <Text style={styles.address}>{item.workStatus} </Text>
        </View>
        <View style={styles.locationRow1}>
          <View style={styles.row1}>
            <Ionicons
              ...
              style={{ marginRight: 5 }}
            />
            <Text style={styles.address}>{item.username}</Text>
          </View>
          {item.workStatus ? (
            <View style={styles.row2}>
              ...
              <Text style={styles.workStatus}>{item.Status} </Text>
            </View>
          ) : null}
        </View>
        ...
        <CustomButton
          ...
          onPress={() => {
            if (item.status === 'Completed') {
              navigation.navigate('fleet_completed_details', {
                fleetbooking: item,
              });
            } else if (item.status === 'Canceled') {
              navigation.navigate('fleet_cancel_details', {
                fleetbooking: item,
              });
            } else if (item.status === 'Confirmed') {
              navigation.navigate('fleet_confirm_details', {
                fleetbooking: item,
              });
            }
          }}
  ...
  return (
    <AuthWrapper>
      ...
      <FlatList
        data={fleetbooking.filter(item => item.type === selectedTab)}
